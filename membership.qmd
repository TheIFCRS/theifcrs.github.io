...
<select id="Profession" name="Role">
  <option value="Unselected"></option>
...
<input name="other-role" type="text" placeholder="Other" required>\

<p>**Main group of interest**</p>

<select id="study" name="Interest">
  <option value="Unselected"></option>
...
If you selected other, please specify:
<input name="other-study" type="text" placeholder="Other" required>\
...
<select id="age" name="Age">
  ...
  <option value="Palaeozoic">Palaeozoic</option>
</select>
...
<select id="confirm" name="Confirm">
  <option value="Unselected"></option>
  <option value="Confirm">I agree and confirm</option>
</select>
